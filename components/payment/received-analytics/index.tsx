...
type Props = {
  inboundCollectionsMade: number;
  inboundProductsSold: number;
  inboundTotalStock: number;
...
const ReceivedAnalytics = ({
  ...
  return (
    <div className="w-full h-full flex flex-col gap-16">
      ...
      <InventoryContent
        isSent={isSent}
        leftTabText="Most sold"
        rightTabText="Least sold"
        mostInventories={inventory.mostSold}
        leastInventories={inventory.leastSold}
      />
    </div>
  );
};

export default ReceivedAnalytics;
