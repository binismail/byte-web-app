...
type Props = {
  ...
  remove?: <X = ExpenseRecordDetailsType>(index: number) => X | undefined;
  values?: ExpenseRecordDetailsType;
...
export default ExpenseProductWidget;
