      ...
      {getSingleInvoiceLoading ? (
        ...
        <Formik
          ...
          initialValues={{
            ...
            issuedDate: new Date(invoiceDetails.issuedDate).toLocaleDateString(
              'en-CA'
            ),
            ...
            [isService ? 'services' : 'products']: isService
              ? invoiceDetails.services.map(({ _id, ...services }) => services)
              : invoiceDetails.products.map(({ _id, ...products }) => products),
          ...
          onSubmit={(values) => {
            updateInvoiceDetails({
              ...
              .catch((error: any) => {
                console.log(error);
                toast.error(error?.data?.message || `Couldn't update invoice`);
              });
          }}
